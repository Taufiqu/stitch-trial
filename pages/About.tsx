      ...
      <main className="flex-1 w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 text-text-main">
              About the Project
            </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-7 flex flex-col gap-8">
            <section className="bg-white rounded-xl p-6 sm:p-8 border border-border-light relative overflow-hidden group shadow-sm">
              <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none group-hover:opacity-10 transition-opacity">
                <span className="material-symbols-outlined text-[100px] sm:text-[120px] text-primary">monitor_heart</span>
              </div>
              <h3 className="text-xl sm:text-2xl font-bold mb-6 flex items-center gap-3 text-text-main">
            ...
            <section className="bg-white rounded-xl p-6 sm:p-8 border border-border-light shadow-sm">
              <h3 className="text-xl sm:text-2xl font-bold mb-8 flex items-center gap-3 text-text-main">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div className="flex flex-col items-center justify-center p-4 sm:p-6 rounded-lg bg-gray-50 border border-gray-100 hover:border-primary/50 transition-all cursor-default group">
                  <span className="material-symbols-outlined text-3xl sm:text-4xl mb-3 text-cyan-600 group-hover:scale-110 transition-transform">apps</span>
                ...
                <div className="flex flex-col items-center justify-center p-4 sm:p-6 rounded-lg bg-gray-50 border border-gray-100 hover:border-primary/50 transition-all cursor-default group">
                  <span className="material-symbols-outlined text-3xl sm:text-4xl mb-3 text-sky-600 group-hover:scale-110 transition-transform">css</span>
                ...
                <div className="flex flex-col items-center justify-center p-4 sm:p-6 rounded-lg bg-gray-50 border border-gray-100 hover:border-primary/50 transition-all cursor-default group">
                  <span className="material-symbols-outlined text-3xl sm:text-4xl mb-3 text-orange-500 group-hover:scale-110 transition-transform">bar_chart_4_bars</span>
                  <span className="font-bold text-sm text-text-main">Recharts</span>
                  <span className="text-xs text-text-muted mt-1">Data Viz</span>
                </div>
                <div className="flex flex-col items-center justify-center p-4 sm:p-6 rounded-lg bg-gray-50 border border-gray-100 hover:border-primary/50 transition-all cursor-default group">
                  <span className="material-symbols-outlined text-3xl sm:text-4xl mb-3 text-yellow-500 group-hover:scale-110 transition-transform">javascript</span>
                  <span className="font-bold text-sm text-text-main">ES6+</span>
                  <span className="text-xs text-text-muted mt-1">Logic Layer</span>
                </div>
                <div className="flex flex-col items-center justify-center p-4 sm:p-6 rounded-lg bg-gray-50 border border-gray-100 hover:border-primary/50 transition-all cursor-default group">
                  <span className="material-symbols-outlined text-3xl sm:text-4xl mb-3 text-pink-500 group-hover:scale-110 transition-transform">deployed_code</span>
          ...
          <div className="lg:col-span-5 flex flex-col h-full">
            <section className="flex-1 bg-primary rounded-xl overflow-hidden border border-blue-700 flex flex-col shadow-lg">
              <div className="h-48 sm:h-64 bg-cover bg-center relative" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCCD95AqAiC_-yCUW7ZrOBaAyOKZQtuSpIKAbucplMil9naPVO8TnrfDAFUgh3D5siK9X7my9qptG5EBy7I--e9NJ9RXDmqd52hRsrO5CgXBSBKlOuIbC8J7vvzBFYfWoGIZ4yvh43smKxz_uCCEAqbvdpCsM1uh2BMtHJqARqwr8IP_82NF56gSqbGxawI7d7hFVTXM-9Lmjl4f7RdkcOBLepS9zsaVy5dDl5YoQXE09TCPiaR_stRt7bs_g7YysZmharzgw3K8XJL')" }}>
              ...
              <div className="p-6 sm:p-8 flex flex-col flex-1">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-1">The Dataset</h3>
                ...
                <p className="text-blue-50 leading-relaxed mb-8 flex-1 text-sm sm:text-base">
